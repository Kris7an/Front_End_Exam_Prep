...
namespace SeleniumTests
{
    public class SeleniumTests
    {
        ...
        private const string baseUrl = "https://shorturl.kris7an.repl.co/";
        ...
        public void Test_UrlVisits()
        {
            ...
            var urlToVisit = driver.FindElement(By.XPath("//a[@class='shorturl'][contains(.,'http://shorturl.kris7an.repl.co/go/nak')]"));
            urlToVisit.Click();
